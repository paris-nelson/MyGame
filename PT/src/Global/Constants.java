...
public class Constants {
	...
	public static final int MOVEMENT_RANGE_MIN=3;
	public static final int SPEED_PER_UNIT_MOVEMENT_RANGE=76;
	public static final int PRIZE_MONEY_MULTIPLE_BASE=60;
	public static final int PRIZE_MONEY_MULTIPLE_INCREMEMENT=10;
	...
	public static final double BURN_POISON_HP_LOSS_RATE=.0625;
	public static final int CHANCE_FREEZE_CURE=25;
